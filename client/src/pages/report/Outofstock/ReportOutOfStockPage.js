...
import OutOfStockTable from "../Outofstock/table/OutOfStockTable"
import { Button } from '@mui/material';
import Container from '@mui/material/Container';
import "../../report/scss/style.scss"

const ReportOutOfStockPage = () => {
  return (
    <Outofstock />
  )
}
  ...
  return (
    <>
      <Container>
        ...
        <Row className='mb-2 row'>
          ...
          <Col md={5} sm={5} lg={2}>
            <ReactToPrint
              trigger={() => {
                return (<Button className='mb-3' sx={{ width: 190 }} variant='contained'>Print Invoice</Button>)
              }}
      ...
      <div className='tablestyle' ref={componentRef}>
        ...
        <OutOfStockTable DataProduct={DataProduct} />
      </div>
    </>
  )
}
export default ReportOutOfStockPage