...
const UserSetting = () => {
  ...
  useEffect(() => {//set disable button pass
    const checkbtn = pwData.pass_nv === pwData.repass_nv === true 
    const nullvalue = pwData.pass_nv !== "" && pwData.repass_nv !== "" 
    setdisableButton({ ...disableButton, pass: checkbtn && nullvalue ? false : true })
  }, [pwData.pass_nv , pwData.repass_nv,])
